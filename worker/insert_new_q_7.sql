INSERT INTO questions (id, question_text, choices, correct_answer, explanation, category, subject, difficulty, is_custom, created_at, updated_at, catalogs, exam_year) VALUES ('441', '
...
<p><strong>36. ปริมาณนักท่องเที่ยวจากประเทศญี่ปุ่นในปี 2559 เป็นเท่าใด</strong></p>', '{"A":"12,234 คน","B":"12,334 คน","C":"12,434 คน","D":"12,534 คน"}', 'A', '<p><strong>ตอบ 1) 12,234 คน</strong></p><p>ปริมาณนักท่องเที่ยวที่ลดลง เท่ากับ 12,578 × (-2.73 / 100) ≈ -343.38 (หรือประมาณ -344 คน)<br/>ปริมาณนักท่องเที่ยวจากประเทศญี่ปุ่นในปี 2559 เท่ากับ 12,578 - 344 = <strong>12,234 คน</strong></p>', 'ก.พ.', 'ความรู้ความสามารถทั่วไป', 50, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '["ตาราง"]', '2559');
INSERT INTO questions (id, question_text, choices, correct_answer, explanation, category, subject, difficulty, is_custom, created_at, updated_at, catalogs, exam_year) VALUES ('442', '
<p><strong>จากข้อมูลในตาราง จงตอบคำถาม</strong></p>
<p>ข้อมูลปริมาณนักท่องเที่ยวที่เดินทางเข้าประเทศไทยผ่านท่าอากาศยานดอนเมือง ปี 2558-2559</p>
<div class="overflow-x-auto my-4 text-gray-900 dark:text-gray-100">
  <table class="w-full border-collapse border border-gray-400 dark:border-gray-600 text-sm">
...
<p><strong>37. ในช่วงปี 2558 - 2559 ประเทศใดมีอัตราการเพิ่มขึ้นของนักท่องเที่ยวน้อยที่สุด</strong></p>', '{"A":"แคนาดา","B":"บรูไน","C":"เวียดนาม","D":"สิงคโปร์"}', 'C', '<p><strong>ตอบ 3) เวียดนาม</strong></p><p>หาอัตราการเพิ่มขึ้นของแต่ละประเทศในตัวเลือก:<br/>- <strong>แคนาดา</strong>: ((240,078 - 225,745) / 225,745) × 100 = 6.35%<br/>- <strong>บรูไน</strong>: นักท่องเที่ยวลดลง (ไม่ใช่เพิ่มขึ้น) จึงตัดออก<br/>- <strong>เวียดนาม</strong>: ((16,452 - 15,946) / 15,946) × 100 = <strong>3.17%</strong><br/>- <strong>สิงคโปร์</strong>: อัตราการเพิ่มระบุในตารางแล้ว คือ 17.83%<br/>ดังนั้น <strong>เวียดนาม</strong> มีอัตราการเพิ่มขึ้นน้อยที่สุด</p>', 'ก.พ.', 'ความรู้ความสามารถทั่วไป', 50, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '["ตาราง"]', '2559');
INSERT INTO questions (id, question_text, choices, correct_answer, explanation, category, subject, difficulty, is_custom, created_at, updated_at, catalogs, exam_year) VALUES ('443', '
<p><strong>จากข้อมูลในตาราง จงตอบคำถาม</strong></p>
<p>ข้อมูลปริมาณนักท่องเที่ยวที่เดินทางเข้าประเทศไทยผ่านท่าอากาศยานดอนเมือง ปี 2558-2559</p>
<div class="overflow-x-auto my-4 text-gray-900 dark:text-gray-100">
  <table class="w-full border-collapse border border-gray-400 dark:border-gray-600 text-sm">
...
<p><strong>38. ในปี 2559 ประเทศใดมีนักท่องเที่ยวเดินทางเข้ามาน้อยที่สุด</strong></p>', '{"A":"ญี่ปุ่น","B":"อเมริกา","C":"เวียดนาม","D":"สิงคโปร์"}', 'D', '<p><strong>ตอบ 4) สิงคโปร์</strong></p><p>หาปริมาณนักท่องเที่ยวในปี 2559 ของแต่ละประเทศ:<br/>- <strong>ญี่ปุ่น</strong> (ข้อ 36) = 12,234 คน<br/>- <strong>อเมริกา</strong> (จากตาราง) = 13,020 คน<br/>- <strong>เวียดนาม</strong> (จากตาราง) = 16,452 คน<br/>- <strong>สิงคโปร์</strong>: 10,021 + (10,021 × 17.83/100) = 10,021 + 1,786 = <strong>11,807 คน</strong><br/>ดังนั้น <strong>สิงคโปร์</strong> มีจำนวนน้อยที่สุด</p>', 'ก.พ.', 'ความรู้ความสามารถทั่วไป', 50, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '["ตาราง"]', '2559');
